  ...
  return (
    <section className="relative py-20 w-full overflow-hidden bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f172a]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-base sm:text-lg md:text-xl text-gray-800 mb-6 sm:mb-8 md:mb-10 max-w-3xl mx-auto leading-relaxed font-medium">
          ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ 
        </p>

        {/* Search Bar */}
        <form onSubmit={handleSearchSubmit} className="relative max-w-2xl mx-auto mb-4 sm:mb-6 md:mb-8">
          ...
          <Input
            ...
            className="w-full pl-12 pr-4 py-3 sm:py-4 bg-white/90 border-0 rounded-xl text-gray-900 placeholder-gray-500 search-glow focus:outline-none focus:ring-2 focus:ring-primary text-base sm:text-lg"
